...
:if ([:len [find name="packages.microsoft.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:microsoft-dev" type=FWD name="packages.microsoft.com" }
