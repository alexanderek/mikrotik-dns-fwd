...
:if ([:len [find name="rednote.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:xiaohongshu" match-subdomain=yes type=FWD name="rednote.com" }
